...
public class WohSheathAnimation extends StaticAnimation {
    ...
    public WohSheathAnimation(float convertTime, boolean repeat, String path, Armature armature, float endTimeStamp){
    ...
    public void tick(LivingEntityPatch<?> entitypatch) {
        if (entitypatch instanceof PlayerPatch<?> playerPatch) {
            AnimationPlayer animationPlayer = playerPatch.getAnimator().getPlayerFor(this);
