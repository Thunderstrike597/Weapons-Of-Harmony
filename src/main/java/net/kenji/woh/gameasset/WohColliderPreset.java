...
public class WohColliderPreset implements PreparableReloadListener {
    ...
    public static final Collider SHOTOGATANA = registerCollider(new ResourceLocation(WeaponsOfHarmony.MODID, "shotogatana"), new MultiOBBCollider(5, 1, 1, -1.75F, (double)0.0F, (double)0.0F, (double)-0.95));
